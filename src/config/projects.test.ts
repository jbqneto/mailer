...
function configureActiveProject(): void {
  ...
  process.env.ACTIVE_SMTP_HOST = 'smtp.example.com';
  process.env.ACTIVE_SMTP_PORT = '465';
  process.env.ACTIVE_SMTP_SECURE = 'true';
  process.env.ACTIVE_SMTP_USER = 'sender@example.com';
  process.env.ACTIVE_SMTP_PASSWORD = 'secret';
}
...
describe('loadProjects', () => {
  ...
  it('uses FROM_EMAIL as the default FROM_NAME and infers SMTP auth', () => {
    configureActiveProject();
    ...
    expect(project?.smtp.auth).toEqual({
